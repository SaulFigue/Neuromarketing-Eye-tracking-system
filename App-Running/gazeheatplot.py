...
def draw_heatmap(gazepoints, dispsize, imagefile=None, alpha=0.5, savefilename=None, gaussianwh=200, gaussiansd=None):
    ...
    #heatmap = cv2.resize(heatmap, (dispsize[0], dispsize[1]))
...
#required args
parser.add_argument('input-path', type=str, default='./participants/p00/gazepoints0.csv', help='path to the csv input')
parser.add_argument('display-width', type=int, default=1366, help='an integer representing the display width')
parser.add_argument('display-height', type=int, default=768, help='an integer representing the display height')
...
# python gazeheatplot.py ./participants/p00/gazepoints0.csv 1366 768 -b='./Stimulus/1.png' -o='./participants/p00/Heatmaps/heatmap1.png'