...
class Plot3DScene:
    ...
    # AQUI TMBN REVISAR.. PUEDE QUE LOS LIMITES DE X & Y ESTEN MAL
    # AUNQ ESTO ES MAS DE LA MALLA Y EL ROSTRO EN MALLA
    ...
    def __plot_screen(self) -> None:
        ...
        # screen_x seria [-361mm/2 , 361mm/2]
        # screen_y seria [10mm, 203mm/2] los 10 mm son el offset, 
        # distancia de la camara a la pantalla de la laptop.
        self.ax.plot(0, 0, 0, linestyle="", marker="o", color='b', label='webcam')  # webcam

        screen_x = [-self.screen_width_mm / 2, self.screen_width_mm / 2]
        # AQUI QUIZAS TOQUE MODIFICAR PARA QUE RESULTE BIEN..
    ...
    # %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    #       AQUI PODRIA IR LA IMPLEMENTACION DE HEATMAPS en vez de PLOTEAR
    #       EL LASER POINT, PLOTEAR EL HEATMAP
