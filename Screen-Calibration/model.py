...
class Model(LightningModule):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #    nn.ReLU(inplace=True),
        #    nn.Conv2d(128, 128, kernel_size=(2, 2), stride=(2, 2), padding='valid', bias=False),
    ...
    def forward(self, person_idx: torch.Tensor, full_face: torch.Tensor, right_eye: torch.Tensor, left_eye: torch.Tensor):
        ...
        #aux = t_hat + self.subject_biases[person_idx].squeeze(1)
        #print('Output del modelo = ',aux.shape)
